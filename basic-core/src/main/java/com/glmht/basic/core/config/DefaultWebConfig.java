package com.glmht.basic.core.config;

import com.glmht.basic.core.base.controller.BasicErrorView;
import com.glmht.basic.core.exception.BasicException;
import com.glmht.basic.core.exception.BasicExceptionEnum;
import com.glmht.basic.core.util.DateUtil;
...
public class DefaultWebConfig extends WebMvcConfigurationSupport {
    ...
    @Bean("error")
    public BasicErrorView error() {
        return new BasicErrorView();
    }
    ...
    public class StringToDateConverter implements Converter<String, Date> {
        ...
        public Date convert(String dateString) {
            ...
            if (dateFlag) {
                ...
                throw new BasicException(BasicExceptionEnum.INVLIDE_DATE_STRING);
            }
