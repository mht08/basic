package com.glmht.basic.config.datasource;

import com.alibaba.druid.pool.DruidDataSource;
import com.baomidou.mybatisplus.plugins.OptimisticLockerInterceptor;
import com.baomidou.mybatisplus.plugins.PaginationInterceptor;
import com.glmht.basic.core.config.properties.DruidProperties;
import com.glmht.basic.core.config.properties.MutiDataSourceProperties;
import com.glmht.basic.core.datascope.DataScopeInterceptor;
import com.glmht.basic.core.mutidatasource.DynamicDataSource;
import com.glmht.basic.core.mutidatasource.aop.MultiSourceExAop;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "basic.muti-datasource", name = "open", havingValue = "true")
@EnableTransactionManagement(order = 2)
@MapperScan(basePackages = {"com.glmht.basic.modular.*.dao","com.glmht.basic.multi.mapper"})
public class MultiDataSourceConfig {

    @Bean
    @ConfigurationProperties(prefix = "basic.muti-datasource")
    ...
    public DynamicDataSource mutiDataSource(DruidProperties druidProperties, MutiDataSourceProperties mutiDataSourceProperties) {
        ...
        hashMap.put(mutiDataSourceProperties.getDataSourceNames()[0], dataSourceBasic);
