package com.glmht.basic.generator.engine.config;
...
public class ContextConfig {
    ...
    private String templatePrefixPath = "basicTemplate/advanced";
    private String projectPath = "D:\\ideaSpace\\basic";//模板输出的项目目录
    ...
    private String proPackage = "com.glmht.basic.admin";
    private String coreBasePackage = "com.glmht.basic.core";
    private String modelPackageName = "com.glmht.basic.modular.system.model";        //model的包名
    private String modelMapperPackageName = "com.glmht.basic.modular.system.dao";    //model的dao
