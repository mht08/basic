package com.glmht.basic.generator.action.config;
...
import com.glmht.basic.core.util.FileUtil;
import com.glmht.basic.generator.engine.SimpleTemplateEngine;
import com.glmht.basic.generator.engine.base.BasicTemplateEngine;
import com.glmht.basic.generator.engine.config.ContextConfig;
import com.glmht.basic.generator.engine.config.SqlConfig;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void doBasicGeneration() {
        BasicTemplateEngine basicTemplateEngine = new SimpleTemplateEngine();
        basicTemplateEngine.setContextConfig(contextConfig);
        sqlConfig.setConnection(dataSourceConfig.getConn());
        basicTemplateEngine.setSqlConfig(sqlConfig);
        basicTemplateEngine.setTableInfo(tableInfo);
        basicTemplateEngine.start();
    }
}
