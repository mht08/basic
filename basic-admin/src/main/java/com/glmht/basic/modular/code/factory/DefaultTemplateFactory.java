package com.glmht.basic.modular.code.factory;


import com.glmht.basic.BasicApplication;
import com.glmht.basic.core.CoreFlag;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setAuthor("mht");
        genQo.setProjectPackage(BasicApplication.class.getPackage().getName());
